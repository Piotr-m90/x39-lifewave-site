...
const COPY = {
  pl: {
    ...
    team: {
      ...
      extraTitle: "Co dostajesz EXTRA w moim zespole",
      extraSub: "Czego nie da Ci żaden inny upline w Polsce. Infrastruktura AI, której budowa kosztowałaby kilkadziesiąt tysięcy.",
      reasons: [
  ...
  en: {
    ...
    team: {
      ...
      extraTitle: "What you get EXTRA in my team",
      extraSub: "What no other upline in Poland will give you. AI infrastructure that would cost tens of thousands to build.",
      reasons: [
  ...
  de: {
    ...
    team: {
      ...
      extraTitle: "Was du EXTRA in meinem Team bekommst",
      extraSub: "Was dir kein anderer Upline in Polen geben wird. KI-Infrastruktur, deren Aufbau Zehntausende kosten würde.",
      reasons: [
