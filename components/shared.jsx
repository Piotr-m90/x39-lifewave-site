...
const COPY = {
  pl: {
    ...
    footer: {
      ...
      disclaimerAffiliate: "Przycisk „Kup” prowadzi do oficjalnego sklepu LifeWave przez link partnerski. Produkt kupujesz bezpośrednio od LifeWave Corporation; jako niezależny dystrybutor mogę otrzymać prowizję. Ta strona nie jest oficjalną stroną LifeWave.",
    },
    contact: {
    ...
    deck: {
      open: "Poznaj projekt",
      openSub: "Multimedialna prezentacja · 17 slajdów",
      restart: "Od początku",
      next: "Dalej",
      prev: "Wstecz",
      ...
      slideOf: "Slajd",
      close: "Zamknij",
      hint: "Klikaj elementy grafiki",
      genes: "genów zresetowanych",
      genesHint: " — kliknij",
      notice: "Materiał edukacyjny niezależnego dystrybutora LifeWave · X39 nie jest wyrobem medycznym",
      legalMed: "Plastry X39 nie są wyrobem medycznym (Dyr. 93/42/EWG). Nie diagnozują, nie leczą ani nie zapobiegają chorobom. Konsultuj się z lekarzem.",
      legalMlm: "Niezależny Dystrybutor LifeWave Corporation. Ta strona nie jest oficjalną stroną LifeWave. „Kup” prowadzi do sklepu LifeWave przez link partnerski (mogę otrzymać prowizję). Potencjał zarobkowy zależy od zaangażowania — brak gwarancji przychodów.",
      ...
      slides: [
        ...
        { kicker: "Potwierdzone klinicznie", visual: "benefits", theme: "light",
          ...
          link: { label: "Źródła: badania GHK-Cu", href: "https://pubmed.ncbi.nlm.nih.gov/?term=GHK-Cu+copper+peptide" } },
        ...
        { kicker: "Działanie na ciele", visual: "relief", theme: "dark",
          title: "Tam, gdzie boli — tam płynie sygnał",
          body: "Plaster naklejasz na kark lub w miejscu, które potrzebuje wsparcia. Sygnał świetlny aktywuje regenerację dokładnie tam, gdzie Twoje ciało jej potrzebuje. Wielu użytkowników zgłasza mniej napięcia, mniej bólu i więcej energii już w pierwszych dniach." },
        ...
        { kicker: "Porównanie", visual: "comparison", theme: "dark",
          ...
          link: { label: "Wybierz X39", kind: "buy" } },
        ...
        { kicker: "Dowody", visual: "science", theme: "dark",
          ...
          link: { label: "Zobacz badania (PubMed)", href: "https://pubmed.ncbi.nlm.nih.gov/?term=GHK-Cu+copper+peptide" } },
        ...
        { kicker: "Bez ryzyka", visual: "guarantee", theme: "parchment",
          ...
          body: "Life Wave jest tak pewny technologii, że oferuje pełną gwarancję zwrotu przez 90 dni — bez pytań. Zamawiasz bezpośrednio z laboratorium, zaczynasz „resetować” organizm w 2-5 dni roboczych. Nie widzisz efektu? Odsyłasz i odzyskujesz pełną kwotę. Całe ryzyko jest po naszej stronie.",
          link: { label: "Zamów z gwarancją 90 dni", kind: "buy" } },
  ...
  en: {
    ...
    footer: {
      ...
      disclaimerAffiliate: "The 'Buy' button leads to the official LifeWave store via a partner link. You purchase directly from LifeWave Corporation; as an independent distributor I may receive a commission. This is not an official LifeWave website.",
    },
    contact: {
      eyebrow: "Next step",
    ...
    deck: {
      ...
      openSub: "Multimedia presentation · 17 slides",
      restart: "Restart",
      next: "Next",
      prev: "Back",
      autoplay: "Autoplay",
      slideOf: "Slide",
      close: "Close",
      hint: "Click the graphic elements",
      genes: "genes reset",
      genesHint: " — click",
      notice: "Educational material by an independent LifeWave distributor · X39 is not a medical device",
      legalMed: "X39 patches are not medical devices (Directive 93/42/EEC). They do not diagnose, treat or prevent diseases. Consult your physician.",
      legalMlm: "Independent LifeWave Distributor. This is not an official LifeWave website. 'Buy' leads to the LifeWave store via a partner link (I may earn a commission). Earning potential depends on commitment — no income guarantee.",
      ...
      slides: [
        ...
        { kicker: "Clinically confirmed", visual: "benefits", theme: "light",
          ...
          link: { label: "Sources: GHK-Cu research", href: "https://pubmed.ncbi.nlm.nih.gov/?term=GHK-Cu+copper+peptide" } },
        ...
        { kicker: "How it works on the body", visual: "relief", theme: "dark",
          title: "Where it hurts — the signal flows",
          body: "You apply the patch on the neck or wherever your body needs support. The light signal activates regeneration exactly where it's needed. Many users report less tension, less pain and more energy within the first days." },
        ...
        { kicker: "Comparison", visual: "comparison", theme: "dark",
          ...
          link: { label: "Choose X39", kind: "buy" } },
        ...
        { kicker: "Evidence", visual: "science", theme: "dark",
          ...
          link: { label: "See the research (PubMed)", href: "https://pubmed.ncbi.nlm.nih.gov/?term=GHK-Cu+copper+peptide" } },
        ...
        { kicker: "Risk-free", visual: "guarantee", theme: "parchment",
          ...
          body: "Life Wave is so confident it offers a full 90-day money-back guarantee — no questions asked. Order directly from the lab, start 'resetting' your body in 2-5 business days. Don't see results? Send it back and get a full refund. All the risk is on us.",
          link: { label: "Order with 90-day guarantee", kind: "buy" } },
  ...
  de: {
    ...
    footer: {
      ...
      disclaimerAffiliate: "Die Schaltfläche „Kaufen“ führt über einen Partnerlink zum offiziellen LifeWave-Shop. Du kaufst direkt bei der LifeWave Corporation; als unabhängiger Distributor kann ich eine Provision erhalten. Dies ist keine offizielle LifeWave-Website.",
    },
    contact: {
    ...
    deck: {
      ...
      openSub: "Multimedia-Präsentation · 17 Folien",
      restart: "Neu starten",
      next: "Weiter",
      prev: "Zurück",
      autoplay: "Autoplay",
      slideOf: "Folie",
      close: "Schließen",
      hint: "Klicke die Grafikelemente an",
      genes: "Gene zurückgesetzt",
      genesHint: " — klicken",
      notice: "Bildungsmaterial eines unabhängigen LifeWave-Distributors · X39 ist kein Medizinprodukt",
      legalMed: "X39 Patches sind keine Medizinprodukte (Richtlinie 93/42/EWG). Sie diagnostizieren, behandeln oder verhindern keine Krankheiten. Konsultiere deinen Arzt.",
      legalMlm: "Unabhängiger LifeWave Distributor. Dies ist keine offizielle LifeWave-Website. „Kaufen“ führt über einen Partnerlink zum LifeWave-Shop (ich kann eine Provision erhalten). Verdienstpotenzial hängt vom Engagement ab — keine Einkommensgarantie.",
      ...
      slides: [
        ...
        { kicker: "Klinisch bestätigt", visual: "benefits", theme: "light",
          ...
          link: { label: "Quellen: GHK-Cu-Studien", href: "https://pubmed.ncbi.nlm.nih.gov/?term=GHK-Cu+copper+peptide" } },
        ...
        { kicker: "Wirkung am Körper", visual: "relief", theme: "dark",
          title: "Wo es schmerzt — fließt das Signal",
          body: "Du klebst das Pflaster auf den Nacken oder dorthin, wo dein Körper Unterstützung braucht. Das Lichtsignal aktiviert die Regeneration genau dort, wo sie nötig ist. Viele Nutzer berichten von weniger Spannung, weniger Schmerz und mehr Energie schon in den ersten Tagen." },
        ...
        { kicker: "Vergleich", visual: "comparison", theme: "dark",
          ...
          link: { label: "X39 wählen", kind: "buy" } },
        ...
        { kicker: "Beweise", visual: "science", theme: "dark",
          ...
          link: { label: "Studien ansehen (PubMed)", href: "https://pubmed.ncbi.nlm.nih.gov/?term=GHK-Cu+copper+peptide" } },
        ...
        { kicker: "Risikofrei", visual: "guarantee", theme: "parchment",
          ...
          body: "Life Wave ist so überzeugt, dass es eine volle 90-Tage-Geld-zurück-Garantie bietet — ohne Fragen. Bestelle direkt aus dem Labor, beginne deinen Körper in 2-5 Werktagen zu „resetten“. Keine Wirkung? Schick es zurück und erhalte den vollen Betrag. Das ganze Risiko liegt bei uns.",
          link: { label: "Mit 90-Tage-Garantie bestellen", kind: "buy" } },
